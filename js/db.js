...
const _CARD_DB_FALLBACK = [
  ...
  {id:54,name:"Ekinda",lv:2,mc:2,ma:1,at:6,df:7,sp:3,el:"light",tribe:"Aria",img:"OGcarddbseal/card_54.jpg",fuse:[{reqs:["light"],atk:{name:"Aura Disposal",at:9,mp:2}},{reqs:["light","light"],atk:{name:"Aura Barrier",df:11,mp:1}}],skill_text:["[Skill]- ทำลาย Mystic Card 1 ใบในสนาม เมื่อ Titania รวมร่างกับ [Light] (Mp 2)"],ability_text:null},
  ...
  {id:81,name:"Undine",lv:2,mc:4,ma:1,at:7,df:8,sp:4,el:"water",tribe:"Aria",img:"OGcarddbseal/card_81.jpg",fuse:[{reqs:["water"],atk:{name:"Silent Lake",at:9,mp:2}},{reqs:["water","water"],atk:{name:"Wave Lashes",at:11,mp:3}}],skill_text:null,ability_text:["Seal ใบอื่นทุกใบในสนามฝ่ายเรา At +1 Df +2"]},
  ...
  {id:92,name:"Nerimor Princess Wands",lv:3,mc:4,ma:3,at:9,df:9,sp:4,el:"fire",tribe:"Aria",img:"OGcarddbseal/card_92.jpg",fuse:[{reqs:["fire"],atk:{name:"Furious Flame",at:11,mp:3}},{reqs:["fire","fire"],atk:{name:"Burn Ruination",at:10,mp:5,all:true}}],skill_text:null,ability_text:["[Fire] ทุกใบในสนามฝ่ายเรา At +1 Df -3 (Df Line)"]},
